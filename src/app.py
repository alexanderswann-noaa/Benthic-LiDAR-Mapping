...
def main():
    ...
    las_render_many_parser = subs.add_parser('FilesRender')
    las_render_many_parser_panel_1 = las_render_many_parser.add_argument_group('Image Render for multiple Bin files')
